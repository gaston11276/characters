...
{
	public class WindowDecorations: Window
	{
		Textbox header = new Textbox();
		public List<DecorationTattooZoneGroup> m_available_tattoos = new List<DecorationTattooZoneGroup>();

		UiElementFiveM uiPages = new UiElementFiveM();
		UiElementFiveM uiPage01 = new UiElementFiveM();
		UiElementFiveM uiPage02 = new UiElementFiveM();
		UiElementFiveM uiPage03 = new UiElementFiveM();
		UiElementFiveM uiPage04 = new UiElementFiveM();
		UiElementFiveM uiPage05 = new UiElementFiveM();
		UiElementFiveM uiPage06 = new UiElementFiveM();
		UiElementFiveM uiPage07 = new UiElementFiveM();

		EntryDecoration ChestTop;
		EntryDecoration ChestTopLeft;
		EntryDecoration ChestTopRight;
		EntryDecoration ChestUpper;
		EntryDecoration ChestUpperLeft;
		EntryDecoration ChestUpperRight;
		EntryDecoration ChestMiddle;
		EntryDecoration ChestMiddleLeft;
		EntryDecoration ChestMiddleRight;
		EntryDecoration ChestLower;
		EntryDecoration ChestLowerLeft;
		EntryDecoration ChestLowerRight;
		EntryDecoration SideUpperLeft;
		EntryDecoration SideUpperRight;
		EntryDecoration SideMiddleLeft;
		EntryDecoration SideMiddleRight;
		EntryDecoration SideLowerLeft;
		EntryDecoration SideLowerRight;
		EntryDecoration NeckFront;
		EntryDecoration NeckBack;
		EntryDecoration NeckLeft;
		EntryDecoration NeckRight;
		EntryDecoration BackTop;
		EntryDecoration BackTopLeft;
		EntryDecoration BackTopRight;
		EntryDecoration BackUpper;
		EntryDecoration BackUpperLeft;
		EntryDecoration BackUpperRight;
		EntryDecoration BackMiddle;
		EntryDecoration BackMiddleLeft;
		EntryDecoration BackMiddleRight;
		EntryDecoration BackLower;
		EntryDecoration BackLowerLeft;
		EntryDecoration BackLowerRight;
		EntryDecoration ArmSideUpperLeft;
		EntryDecoration ArmSideUpperRight;
		EntryDecoration ArmSideMiddleLeft;
		EntryDecoration ArmSideMiddleRight;
		EntryDecoration ArmSideLowerLeft;
		EntryDecoration ArmSideLowerRight;
		EntryDecoration ArmFrontUpperLeft;
		EntryDecoration ArmFrontUpperRight;
		EntryDecoration ArmFrontMiddleLeft;
		EntryDecoration ArmFrontMiddleRight;
		EntryDecoration ArmFrontLowerLeft;
		EntryDecoration ArmFrontLowerRight;
		EntryDecoration ArmInsideUpperLeft;
		EntryDecoration ArmInsideUpperRight;
		EntryDecoration ArmInsideMiddleLeft;
		EntryDecoration ArmInsideMiddleRight;
		EntryDecoration ArmInsideLowerLeft;
		EntryDecoration ArmInsideLowerRight;
		EntryDecoration ArmBackUpperLeft;
		EntryDecoration ArmBackUpperRight;
		EntryDecoration ArmBackMiddleLeft;
		EntryDecoration ArmBackMiddleRight;
		EntryDecoration ArmBackLowerLeft;
		EntryDecoration ArmBackLowerRight;
		EntryDecoration LegSideUpperLeft;
		EntryDecoration LegSideUpperRight;
		EntryDecoration LegSideMiddleLeft;
		EntryDecoration LegSideMiddleRight;
		EntryDecoration LegSideLowerLeft;
		EntryDecoration LegSideLowerRight;
		EntryDecoration LegFrontUpperLeft;
		EntryDecoration LegFrontUpperRight;
		EntryDecoration LegFrontMiddleLeft;
		EntryDecoration LegFrontMiddleRight;
		EntryDecoration LegFrontLowerLeft;
		EntryDecoration LegFrontLowerRight;
		EntryDecoration LegBackUpperLeft;
		EntryDecoration LegBackUpperRight;
		EntryDecoration LegBackMiddleLeft;
		EntryDecoration LegBackMiddleRight;
		EntryDecoration LegBackLowerLeft;
		EntryDecoration LegBackLowerRight;
		EntryDecoration Face;
		EntryDecoration Unknown;
		...
		private void SetCamera(DecorationZone zone)
		{
			...
			UiCamera.SetCamera(distance, height, rotation);
		}
		...
		protected void CreateColumn(UiElementFiveM uiPanel, HGravity gravity, string label = null)
		{
			UiElementFiveM uiColumn = new UiElementFiveM();
		...
		protected void CreatePageColumns(UiElementFiveM uiPage)
		{
		...
		{
			uiPages.SetPadding(new UiRectangle(0f));
			uiPages.SetFlags(TRANSPARENT);
			AddElement(uiPages);
			uiPages.SetMoveFlags(HIDDEN);

			// Buttons
			UiElementFiveM uiPagesButtons = new UiElementFiveM();
			uiPagesButtons.SetPadding(new UiRectangle(defaultPadding));
			uiPagesButtons.SetFlags(TRANSPARENT);
			AddElement(uiPagesButtons);

			Textbox buttonPrev = new Textbox();
			buttonPrev.SetText("Prev");
			buttonPrev.SetFont(Font.CharletComprimeColonge);
			buttonPrev.SetPadding(new UiRectangle(defaultPadding));
			buttonPrev.SetProperties(CANFOCUS);
			buttonPrev.RegisterOnLMBRelease(uiPages.MoveFlagsUp);
			buttonPrev.RegisterOnLMBRelease(RefreshPageInfo);
			uiPages.RegisterOnFirst(buttonPrev.Disable);

			WindowManager.RegisterOnMouseMoveCallback(buttonPrev.OnMouseMove);
			WindowManager.RegisterOnMouseButtonCallback(buttonPrev.OnMouseButton);
			uiPagesButtons.AddElement(buttonPrev);

			Textbox buttonNext = new Textbox();
			buttonNext.SetText("Next");
			buttonNext.SetFont(Font.CharletComprimeColonge);
			buttonNext.SetPadding(new UiRectangle(defaultPadding));
			buttonNext.SetProperties(CANFOCUS);
			buttonNext.RegisterOnLMBRelease(uiPages.MoveFlagsDown);
			buttonNext.RegisterOnLMBRelease(RefreshPageInfo);
			buttonNext.RegisterOnLMBRelease(buttonPrev.Enable);
			uiPages.RegisterOnLast(buttonNext.Disable);
			buttonPrev.RegisterOnLMBRelease(buttonNext.Enable);
			WindowManager.RegisterOnMouseMoveCallback(buttonNext.OnMouseMove);
			WindowManager.RegisterOnMouseButtonCallback(buttonNext.OnMouseButton);
			uiPagesButtons.AddElement(buttonNext);

			uiPage01.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage01);
			uiPages.AddElement(uiPage01);

			uiPage02.SetFlags(HIDDEN);
			uiPage02.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage02);
			uiPages.AddElement(uiPage02);

			uiPage03.SetFlags(HIDDEN);
			uiPage03.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage03);
			uiPages.AddElement(uiPage03);

			uiPage04.SetFlags(HIDDEN);
			uiPage04.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage04);
			uiPages.AddElement(uiPage04);

			uiPage05.SetFlags(HIDDEN);
			uiPage05.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage05);
			uiPages.AddElement(uiPage05);

			uiPage06.SetFlags(HIDDEN);
			uiPage06.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage06);
			uiPages.AddElement(uiPage06);

			uiPage07.SetFlags(HIDDEN);
			uiPage07.SetPadding(new UiRectangle(defaultPadding));
			CreatePageColumns(uiPage07);
			uiPages.AddElement(uiPage07);
		}

		private EntryDecoration CreateEntry(UiElementFiveM page, DecorationZone zone, string label)
		{
			UiElementFiveM columnZoneLabels = (UiElementFiveM)page.GetElement(0);
			UiElementFiveM columnName = (UiElementFiveM)page.GetElement(1);
			UiElementFiveM columnIndex = (UiElementFiveM)page.GetElement(2);
			UiElementFiveM columnDecrease = (UiElementFiveM)page.GetElement(3);
			UiElementFiveM columnIncrease = (UiElementFiveM)page.GetElement(4);

			EntryDecoration entry = new EntryDecoration();
			entry.zone = zone;

			entry.uiZoneLabel.SetFont(Font.CharletComprimeColonge);
			...
			entry.uiTattooName.SetFont(Font.CharletComprimeColonge);
			...
			entry.uiTattooIndex.SetFont(Font.CharletComprimeColonge);
		...
		public override void CreateUi()
		{
			...
			SetAlignment(VAlignment.Bottom);
			SetProperties(FLOATING | MOVABLE | COLLISION_PARENT);
			SetOrientation(Orientation.Vertical);

			header.SetText("Decorations");
			...
			ChestTop = CreateEntry(uiPage01, DecorationZone.ChestTop, "Chest Top");
			ChestTopLeft = CreateEntry(uiPage01, DecorationZone.ChestTopLeft, "Chest Top Left");
			ChestTopRight = CreateEntry(uiPage01, DecorationZone.ChestTopRight, "ChestTopRight");
			ChestUpper = CreateEntry(uiPage01, DecorationZone.ChestUpper, "ChestUpper");
			ChestUpperLeft = CreateEntry(uiPage01, DecorationZone.ChestUpperLeft, "ChestUpperLeft");
			ChestUpperRight = CreateEntry(uiPage01, DecorationZone.ChestUpperRight, "ChestUpperRight");
			ChestMiddle = CreateEntry(uiPage01, DecorationZone.ChestMiddle, "ChestMiddle");
			ChestMiddleLeft = CreateEntry(uiPage01, DecorationZone.ChestMiddleLeft, "ChestMiddleLeft");
			ChestMiddleRight = CreateEntry(uiPage01, DecorationZone.ChestMiddleRight, "ChestMiddleRight");
			ChestLower = CreateEntry(uiPage01, DecorationZone.ChestLower, "ChestLower");
			ChestLowerLeft = CreateEntry(uiPage01, DecorationZone.ChestLowerLeft, "ChestLowerLeft");
			ChestLowerRight = CreateEntry(uiPage01, DecorationZone.ChestLowerRight, "ChestLowerRight");
			SideUpperLeft = CreateEntry(uiPage02, DecorationZone.SideUpperLeft, "SideUpperLeft");
			SideUpperRight = CreateEntry(uiPage02, DecorationZone.SideUpperRight, "SideUpperRight");
			SideMiddleLeft = CreateEntry(uiPage02, DecorationZone.SideMiddleLeft, "SideMiddleLeft");
			SideMiddleRight = CreateEntry(uiPage02, DecorationZone.SideMiddleRight, "SideMiddleRight");
			SideLowerLeft = CreateEntry(uiPage02, DecorationZone.SideLowerLeft, "SideLowerLeft");
			SideLowerRight = CreateEntry(uiPage02, DecorationZone.SideLowerRight, "SideLowerRight");
			NeckFront = CreateEntry(uiPage03, DecorationZone.NeckFront, "NeckFront");
			NeckBack = CreateEntry(uiPage03, DecorationZone.NeckBack, "NeckBack");
			NeckLeft = CreateEntry(uiPage03, DecorationZone.NeckLeft, "NeckLeft");
			NeckRight = CreateEntry(uiPage03, DecorationZone.NeckRight, "NeckRight");
			BackTop = CreateEntry(uiPage04, DecorationZone.BackTop, "BackTop");
			BackTopLeft = CreateEntry(uiPage04, DecorationZone.BackTopLeft, "BackTopLeft");
			BackTopRight = CreateEntry(uiPage04, DecorationZone.BackTopRight, "BackTopRight");
			BackUpper = CreateEntry(uiPage04, DecorationZone.BackUpper, "BackUpper");
			BackUpperLeft = CreateEntry(uiPage04, DecorationZone.BackUpperLeft, "BackUpperLeft");
			BackUpperRight = CreateEntry(uiPage04, DecorationZone.BackUpperRight, "BackUpperRight");
			BackMiddle = CreateEntry(uiPage04, DecorationZone.BackMiddle, "BackMiddle");
			BackMiddleLeft = CreateEntry(uiPage04, DecorationZone.BackMiddleLeft, "BackMiddleLeft");
			BackMiddleRight = CreateEntry(uiPage04, DecorationZone.BackMiddleRight, "BackMiddleRight");
			BackLower = CreateEntry(uiPage04, DecorationZone.BackLower, "BackLower");
			BackLowerLeft = CreateEntry(uiPage04, DecorationZone.BackLowerLeft, "BackLowerLeft");
			BackLowerRight = CreateEntry(uiPage04, DecorationZone.BackLowerRight, "BackLowerRight");
			ArmSideUpperLeft = CreateEntry(uiPage05, DecorationZone.ArmSideUpperLeft, "ArmSideUpperLeft");
			ArmSideUpperRight = CreateEntry(uiPage05, DecorationZone.ArmSideUpperRight, "ArmSideUpperRight");
			ArmSideMiddleLeft = CreateEntry(uiPage05, DecorationZone.ArmSideMiddleLeft, "ArmSideMiddleLeft");
			ArmSideMiddleRight = CreateEntry(uiPage05, DecorationZone.ArmSideMiddleRight, "ArmSideMiddleRight");
			ArmSideLowerLeft = CreateEntry(uiPage05, DecorationZone.ArmSideLowerLeft, "ArmSideLowerLeft");
			ArmSideLowerRight = CreateEntry(uiPage05, DecorationZone.ArmSideLowerRight, "ArmSideLowerRight");
			ArmFrontUpperLeft = CreateEntry(uiPage05, DecorationZone.ArmFrontUpperLeft, "ArmFrontUpperLeft");
			ArmFrontUpperRight = CreateEntry(uiPage05, DecorationZone.ArmFrontUpperRight, "ArmFrontUpperRight");
			ArmFrontMiddleLeft = CreateEntry(uiPage05, DecorationZone.ArmFrontMiddleLeft, "ArmFrontMiddleLeft");
			ArmFrontMiddleRight = CreateEntry(uiPage05, DecorationZone.ArmFrontMiddleRight, "ArmFrontMiddleRight");
			ArmFrontLowerLeft = CreateEntry(uiPage05, DecorationZone.ArmFrontLowerLeft, "ArmFrontLowerLeft");
			ArmFrontLowerRight = CreateEntry(uiPage05, DecorationZone.ArmFrontLowerRight, "ArmFrontLowerRight");
			ArmInsideUpperLeft = CreateEntry(uiPage05, DecorationZone.ArmInsideUpperLeft, "ArmInsideUpperLeft");
			ArmInsideUpperRight = CreateEntry(uiPage05, DecorationZone.ArmInsideUpperRight, "ArmInsideUpperRight");
			ArmInsideMiddleLeft = CreateEntry(uiPage05, DecorationZone.ArmInsideMiddleLeft, "ArmInsideMiddleLeft");
			ArmInsideMiddleRight = CreateEntry(uiPage05, DecorationZone.ArmInsideMiddleRight, "ArmInsideMiddleRight");
			ArmInsideLowerLeft = CreateEntry(uiPage05, DecorationZone.ArmInsideLowerLeft, "ArmInsideLowerLeft");
			ArmInsideLowerRight = CreateEntry(uiPage05, DecorationZone.ArmInsideLowerRight, "ArmInsideLowerRight");
			ArmBackUpperLeft = CreateEntry(uiPage05, DecorationZone.ArmBackUpperLeft, "ArmBackUpperLeft");
			ArmBackUpperRight = CreateEntry(uiPage05, DecorationZone.ArmBackUpperRight, "ArmBackUpperRight");
			ArmBackMiddleLeft = CreateEntry(uiPage05, DecorationZone.ArmBackMiddleLeft, "ArmBackMiddleLeft");
			ArmBackMiddleRight = CreateEntry(uiPage05, DecorationZone.ArmBackMiddleRight, "ArmBackMiddleRight");
			ArmBackLowerLeft = CreateEntry(uiPage05, DecorationZone.ArmBackLowerLeft, "ArmBackLowerLeft");
			ArmBackLowerRight = CreateEntry(uiPage05, DecorationZone.ArmBackLowerRight, "ArmBackLowerRight");
			LegSideUpperLeft = CreateEntry(uiPage06, DecorationZone.LegSideUpperLeft, "LegSideUpperLeft");
			LegSideUpperRight = CreateEntry(uiPage06, DecorationZone.LegSideUpperRight, "LegSideUpperRight");
			LegSideMiddleLeft = CreateEntry(uiPage06, DecorationZone.LegSideMiddleLeft, "LegSideMiddleLeft");
			LegSideMiddleRight = CreateEntry(uiPage06, DecorationZone.LegSideMiddleRight, "LegSideMiddleRight");
			LegSideLowerLeft = CreateEntry(uiPage06, DecorationZone.LegSideLowerLeft, "LegSideLowerLeft");
			LegSideLowerRight = CreateEntry(uiPage06, DecorationZone.LegSideLowerRight, "LegSideLowerRight");
			LegFrontUpperLeft = CreateEntry(uiPage06, DecorationZone.LegFrontUpperLeft, "LegFrontUpperLeft");
			LegFrontUpperRight = CreateEntry(uiPage06, DecorationZone.LegFrontUpperRight, "LegFrontUpperRight");
			LegFrontMiddleLeft = CreateEntry(uiPage06, DecorationZone.LegFrontMiddleLeft, "LegFrontMiddleLeft");
			LegFrontMiddleRight = CreateEntry(uiPage06, DecorationZone.LegFrontMiddleRight, "LegFrontMiddleRight");
			LegFrontLowerLeft = CreateEntry(uiPage06, DecorationZone.LegFrontLowerLeft, "LegFrontLowerLeft");
			LegFrontLowerRight = CreateEntry(uiPage06, DecorationZone.LegFrontLowerRight, "LegFrontLowerRight");
			LegBackUpperLeft = CreateEntry(uiPage06, DecorationZone.LegBackUpperLeft, "LegBackUpperLeft");
			LegBackUpperRight = CreateEntry(uiPage06, DecorationZone.LegBackUpperRight, "LegBackUpperRight");
			LegBackMiddleLeft = CreateEntry(uiPage06, DecorationZone.LegBackMiddleLeft, "LegBackMiddleLeft");
			LegBackMiddleRight = CreateEntry(uiPage06, DecorationZone.LegBackMiddleRight, "LegBackMiddleRight");
			LegBackLowerLeft = CreateEntry(uiPage06, DecorationZone.LegBackLowerLeft, "LegBackLowerLeft");
			LegBackLowerRight = CreateEntry(uiPage06, DecorationZone.LegBackLowerRight, "LegBackLowerRight");
			Face = CreateEntry(uiPage07, DecorationZone.Face, "Face");
			Unknown = CreateEntry(uiPage07, DecorationZone.Unknown, "Unknown");
		...
		{
			List<UiElement> openPages = uiPages.GetElementsCleared(HIDDEN);
			if (openPages.Count > 0)
			{
				int openedPageIndex = uiPages.GetElementIndex(openPages[0]);
				header.SetText($"Tattoos {openedPageIndex + 1}/{uiPages.GetNumElements()}");
			}
		}
		...
		private async void SetTattooIndex(DecorationZone zone, int index)
		{
			switch (zone)
			{
				case DecorationZone.ChestTop:
